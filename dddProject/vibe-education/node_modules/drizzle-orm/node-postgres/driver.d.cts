...
export declare function drizzle<TSchema extends Record<string, unknown> = Record<string, never>, TClient extends NodePgClient = NodePgClient>(client: TClient, config?: DrizzleConfig<TSchema>): NodePgDatabase<TSchema> & {
    $client: TClient;
};
